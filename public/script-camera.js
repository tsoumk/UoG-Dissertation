...
var GazeCloudAPI = new function GazeCloudAPIInit() {
    ...
    function UpdateGUI(GazeData) {
        ...
        try {
            ...
            console.log("update gui exeption ", e);
        }
    } //-----------------------------------
...
window.document.GazeCloudAPI = GazeCloudAPI